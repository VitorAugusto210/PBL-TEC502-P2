...
class BlockchainService:
    def __init__(self):
        ...
        # CORREÇÃO 2: Injetar o middleware PoA (necessário para Ganache)
        # Isso garante compatibilidade com redes de Proof-of-Authority como o Ganache
        self.w3.middleware_onion.inject(ExtraDataToPOAMiddleware, layer=0)

        # Carrega o ABI e o endereço do contrato
        # O script espera um pouco para garantir que os arquivos foram criados pelo deployer
        ...
        print(f"BlockchainService inicializado com sucesso. Conectado a {self.provider_url} e usando o contrato em {self.contract_address}")

    def _connect_with_retry(self, timeout=60):
        """Tenta se conectar ao provedor blockchain com várias tentativas."""
